...
export function VibeQuestLogoMark({ className = "h-8 w-8" }: VibeQuestLogoMarkProps) {
  return (
...
export function VibeQuestBrand({
  ...
  labelClassName = "block truncate text-[22px] font-black tracking-[-0.03em] text-white",
}: VibeQuestBrandProps) {
  return (
